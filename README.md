...
<header class="header fixed-top">
   ...
   <div class="container">
      ...
      <div class="row align-items-center justify-content-between">
         ...
         <a href="#" class="logo"><span>PERSONAL</span><br>FIT</a>
...
<section class="home" id="home">
   ...
   <div class="container">
      ...
      <div class="row align-items-center min-vh-100">
         ...
         <div class="col-md-6">
            <img src="images/26.png" class="w-100" alt="">
         </div>

         <div class="col-md-6 text-center text-md-left">
            <span>back to the gym</span>
            <h3>start your fitness journey today with our trainers</h3>
...
<section class="pricing" id="pricing">
   ...
   <div class="box-container container">
      ...
      <div class="box">
         <h3>ultimate plan</h3>
         <div class="price"><span>Rs.</span>2800<span>/mo</span></div>
         <a href="#" class="link-btn">choose the plan</a>
         <div class="list">
            <p> <i class="fas fa-check"></i> personal training </p>
            <p> <i class="fas fa-check"></i> classes per week </p>
...
<section class="footer">
   ...
   <p class="credit"> created by <span>FOCUS Web designers</span> | all rights reserved! </p>
